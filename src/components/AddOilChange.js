    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4">
          <h2 className="text-xl font-bold text-white">Add Oil Change</h2>
        </div>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg overflow-hidden shadow-xl max-w-md w-full">
            <div className="bg-green-100 p-6">
              ...
              <h3 className="text-lg font-medium text-green-900 text-center mt-4">Oil Change Added Successfully</h3>
              <p className="text-sm text-green-700 text-center mt-2">The oil change record has been created.</p>
            </div>
