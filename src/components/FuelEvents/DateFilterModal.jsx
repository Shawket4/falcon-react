...
import { Calendar, X, Check, Zap, Filter } from 'lucide-react';
      ...
      <div className="mb-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <span className="text-sm font-medium text-gray-700">Method Filter</span>
              <p className="text-xs text-gray-500">
                {isPetroAppOnly ? 'Showing PetroApp entries only' : 'Showing all methods'}
              </p>
            </div>
          </div>
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
              isPetroAppOnly ? 'bg-blue-600' : 'bg-gray-300'
            }`}
          >
            <span
              className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform shadow-sm ${
                isPetroAppOnly ? 'translate-x-6' : 'translate-x-1'
              }`}
            />
          </button>
        </div>
      ...
      <div className="border-t border-gray-200 pt-3">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-shrink-0 w-full md:w-40 space-y-4">
            <div>
              <h5 className="text-sm font-medium text-gray-500 mb-2 flex items-center gap-1.5">
