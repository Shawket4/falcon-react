...
import { Calendar, X, Check, RefreshCw } from 'lucide-react';
    ...
    <div className="absolute z-10 bg-white shadow-xl rounded-xl p-5 mt-2 right-0 w-80 sm:w-96 border border-gray-200 animate-fadeIn">
      ...
      <div className="mb-4">
        <button
          ...
          className="w-full text-blue-600 bg-blue-50 hover:bg-blue-100 py-2 px-3 rounded-lg transition-colors text-sm flex items-center justify-center"
        >
